...
export default function Footer() {
    return (
        <footer className="mt-12 border-t border-white/10 bg-gray-500/5">
            ...
            <div className="border-t border-white/10 px-6 py-5 text-center text-xs leading-5 text-gray-500">
